                    ...
                    <div class="card-header d-flex justify-content-between">
                     ...
                     <!-- exist -->
                       ...
                       <?php }unset($_SESSION['exist'])?>
                           <!-- exist -->
                    <div class="card-body">
                        <form action="candidate_registration_post.php" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                           ...
                           <!-- division err -->
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="symbol_name" value="<?=(isset($_SESSION['old_division'])?$_SESSION['old_division']:'')?>">
                            </div>

                            <!-- division err -->
                            <?php if(isset($_SESSION['symbol_name_err'])){ ?>
                                <div class="alert alert-success mt-2"><?=$_SESSION['symbol_name_err']?></div>
                            <?php }unset($_SESSION['symbol_name_err'])?>
                           <!-- division err -->
                           ...
                           <!-- photo err -->
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" name="symbol" class="form-control" onchange="document.getElementById('klah').src = window.URL.createObjectURL(this.files[0])">
                                <img id="klah" width="150" src="" alt="">
                            </div>

                            <!-- symbol err -->
                            <?php if(isset($_SESSION['symbol_err'])){ ?>
                                <div class="alert alert-success"><?=$_SESSION['symbol_err']?></div>
                            <?php }unset($_SESSION['symbol_err'])?>
                           <!-- symbol err -->
                            <div class="mb-3">
